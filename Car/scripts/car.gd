...
var cameraOrbit # A placeholder for the camera object
var followCameraY = 0
...
var MAX_ENGINE_FORCE = 1000.0 # The maximum engine power capable of being applied
var MAX_BRAKE = 30.0 # The maximum braking power capable of being applied
var MAX_STEERING = 0.7 # How far the front wheels can turn left and right
var STEERING_SPEED = 4 # How fast the wheels turn when the arrow keys are pressed
...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("ui_cancel"): # Show or hide the Settingspanel with pressing ESC
		if (show_settings):
